...
open class PasscodeLock: PasscodeLockType {
    ...
    open func authenticateWithTouchID() {
        ...
        let reason = "Authentication required to proceed"//localizedStringFor(key: "PasscodeLockTouchIDReason", comment: "TouchID authentication reason")

        context.localizedFallbackTitle = "Enter Passcode" //localizedStringFor(key: "PasscodeLockTouchIDButton", comment: "TouchID authentication fallback button")
