...
struct RemovePasscodeState: PasscodeLockStateType {
    ...
    init() {
        title = "Enter Passcode"//localizedStringFor(key: "PasscodeLockEnterTitle", comment: "Enter passcode title")
        description = "Enter your passcode to proceed." // localizedStringFor(key: "PasscodeLockEnterDescription", comment: "Enter passcode description")
    }
